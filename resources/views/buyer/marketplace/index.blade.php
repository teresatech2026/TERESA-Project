<x-app-layout>
    ...
    <form method="GET" action="{{ route('marketplace.index') }}" class="mb-6">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div class="relative max-w-md w-full sm:w-auto flex-1">
            ...
            @if ($search)
                <a href="{{ route('marketplace.index') }}" class="text-xs text-primary-600 hover:underline font-medium whitespace-nowrap">
