<x-app-layout>
    <style>
        ...
        .about-card { transition: transform 0.25s ease, box-shadow 0.25s ease; }
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <!-- About TERESA -->
            <div class="about-card relative overflow-hidden bg-white shadow-sm hover:shadow-xl rounded-xl p-8">
                <div class="absolute -top-6 -right-6 w-28 h-28 bg-primary-50 rounded-full"></div>
                <div class="relative flex items-start gap-4">
                    <div class="w-12 h-12 shrink-0 rounded-xl bg-primary-600 flex items-center justify-center shadow-md shadow-primary-600/30">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-primary-700 mb-3">About TERESA</h3>
            ...
            <!-- Our Purpose -->
            <div class="about-card relative overflow-hidden bg-white shadow-sm hover:shadow-xl rounded-xl p-8">
                <div class="absolute -bottom-8 -left-8 w-32 h-32 bg-accent-50 rounded-full"></div>
                <div class="relative flex items-start gap-4">
                    <div class="w-12 h-12 shrink-0 rounded-xl bg-accent-500 flex items-center justify-center shadow-md shadow-accent-500/30">
                        <svg class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" />
                        </svg>
                    </div>
                    <div>
                        <h3 class="text-xl font-bold text-primary-700 mb-3">Our Purpose</h3>
                        <p class="text-gray-600 leading-relaxed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="about-card relative overflow-hidden bg-gradient-to-br from-primary-50 to-white shadow-sm hover:shadow-xl rounded-xl p-8">
                    <div class="w-11 h-11 rounded-lg bg-primary-600 flex items-center justify-center mb-4 shadow-md shadow-primary-600/30">
                        <svg class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                ...
                <div class="about-card relative overflow-hidden bg-gradient-to-br from-accent-50 to-white shadow-sm hover:shadow-xl rounded-xl p-8">
                    <div class="w-11 h-11 rounded-lg bg-accent-500 flex items-center justify-center mb-4 shadow-md shadow-accent-500/30">
                        <svg class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <!-- What TERESA Offers -->
            <div class="relative overflow-hidden bg-white shadow-sm rounded-xl p-8">
                <div class="flex items-center gap-3 mb-1">
                    <div class="w-10 h-10 rounded-lg bg-primary-600 flex items-center justify-center shadow-md shadow-primary-600/30">
                    ...
                    <h3 class="text-lg font-bold text-primary-700">What TERESA Offers</h3>
                </div>
                <p class="text-sm text-gray-500 mb-6 ml-[52px]">Everything you need in one place.</p>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">

                    <div class="about-card group border border-gray-200 rounded-xl p-5 hover:border-primary-600 hover:shadow-lg">
                        <div class="w-10 h-10 rounded-full bg-primary-50 group-hover:bg-primary-600 flex items-center justify-center mb-3 transition-colors">
                            <svg class="w-5 h-5 text-primary-700 group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <div class="relative overflow-hidden bg-white shadow-sm rounded-xl p-8">
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-10 h-10 rounded-lg bg-accent-500 flex items-center justify-center shadow-md shadow-accent-500/30">
                        <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-bold text-primary-700">Who We Serve</h3>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    <div class="about-card text-center p-6 rounded-xl bg-gray-50 hover:bg-primary-50 hover:shadow-md">
                    ...
                    <div class="about-card text-center p-6 rounded-xl bg-gray-50 hover:bg-accent-50 hover:shadow-md">
